...
Docstring for projects.bulk_file_renamer
    ...
    The program should enable users to select a directory and automatically rename all files using rules such as adding a prefix or suffix, numbering files sequentially.
"""
import os
